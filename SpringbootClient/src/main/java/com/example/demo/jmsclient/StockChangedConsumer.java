    ...
    */
    ...
    public void onMessage(ActiveMQTextMessage message) throws JMSException, JsonProcessingException {
        ...
        if (message !=null ) {
            ...
            logger.info("StockChangedConsumer received stock-changed  message:"+text);
            StockChanged  object = objectMapper.readValue(text, StockChanged.class);
            logger.info("StockChangedConsumer received stock-changed  object = :"+object.toString());
        } else {
